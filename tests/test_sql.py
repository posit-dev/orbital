...
class TestSQLExport:
    ...
    def test_sql(self):
        ...
        assert sql == (
            'WITH "t1" AS (SELECT ("t0"."sepal_length" - 5.84333E0) * -0.111906E0 + '
